...
class Pong {
    ...
    update = (dt) => {
        ...
        let posY = this.checkHeight(this.ball.pos.y - 100, this._canvas);
        // AI Position Padel with fixed height and easing
        const normalisedEase = this.easeInOutBack(this.stretchRange(posY, 100, this._canvas.height - 100, 0, 1));
        const unNormalisedValue = this.stretchRange(normalisedEase, 0, 1, 100, this._canvas.height - 100);
